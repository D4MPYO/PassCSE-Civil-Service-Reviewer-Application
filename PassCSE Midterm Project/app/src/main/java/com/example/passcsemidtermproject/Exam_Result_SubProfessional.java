...
public class Exam_Result_SubProfessional extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.result_exam_subprofessional);
        ...
        timeSpentValueTextView.setText(timeSpent); // Set the time spent value

        // Set colors based on performance
        correctAnswerValueTextView.setTextColor(Color.GREEN); // Correct answers are always green
        wrongAnswerValueTextView.setTextColor(Color.RED); // Wrong answers are always red
        timeSpentValueTextView.setTextColor(Color.BLUE); // Time spent is always blue
